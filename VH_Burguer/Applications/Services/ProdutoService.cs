...
namespace VHBurguer.Applications.Services
{
    public class ProdutoService
    {
        ...
        // Criar um DTO com apenas o que a requisição do front precisa.
        ...
        public LerProdutoDto Atualizar(int id, AtualizarProdutoDto produtoDto)
        {
            ...
            // produtoIdAtual: -> os dois pontos servem para passar o valor do parâmetro
            ...
            if (produtoDto.CategoriaIds == null || produtoDto.CategoriaIds.Count == 0)
            {
                throw new DomainException("O produto deve ter ao menos uma categoria.");
            }
