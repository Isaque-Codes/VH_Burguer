...
namespace VH_Burguer.Repositories
{
    public class ProdutoRepository : IProdutoRepository
    {
        ...
        {
            //Busca produtos e suas categorias
            List<Produto> produtos = _context.Produto
            .Include(produto => produto.Categoria)
            .Include(produto => produto.Usuario) // Usuarios também
            .ToList();
        ...
        public Produto ObterPorId(int id)
        {
            ...
            // Verifica se o ID do produto é igual ao do parâmetro
        ...
        {
            // AsQueryable() -> Monta a consulta para na tabela produto executar passo a passo
            // Não executa nada no banco ainda, apenas verifica existência
        ...
        public void Atualizar(Produto produto, List<int> categoriaIds)
        {
            ...
            // Busca no banco categorias com o ID igual das categorias que vieram da requisição
            var categorias = _context.Categoria
                .Where(categoria => categoriaIds
                .Contains(categoria.CategoriaID))
                .ToList();

            // Remove as ligações ProdutoCategoria no banco
