...
namespace VH_Burguer.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public ActionResult<LerUsuarioDto> Atualizar (int id, CriarUsuarioDto usuarioDto)
        {
            try
            {
                LerUsuarioDto usuarioAualizado = _service.Atualizar(id, usuarioDto);
                return StatusCode(200, usuarioAualizado);
            }
        ...
        // Inativa o usuário em vez de deletar, devido à trigger no banco (SOFT DELETE)
        [HttpDelete("{id}")]
